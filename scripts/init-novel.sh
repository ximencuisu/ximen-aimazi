...
copy_template ".learnings/PLOT_SUSPENSE.md"
...
copy_template "memory/project_genres.md"
copy_template "memory/style_contrast_guide.md"
copy_template "memory/feedback_style.md"
copy_template "memory/feedback_interaction.md"
copy_template "memory/user_profile.md"
copy_template "memory/reference_tools.md"
copy_template "memory/reference_templates.md"
...
copy_template "设定/作品DNA.md"
copy_template "设定/风格指纹.md"
copy_template "设定/不可改动清单.md"
copy_template "设定/续写诊断.md"
copy_template "设定/续写方案.md"
